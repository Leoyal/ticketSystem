...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block"  aria-expanded="false">
            <i class="fa fa-user-md" aria-hidden="true" style="color: white;font-size: 17px;">
                {{ Auth::user()->lname.' '.Auth::user()->fname }}
                <span class="caret"></span>
            </i>
        </a>
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="show-registered-data" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Show Registered Data</p>
                </a>
              </li>
            </li>
        </ul>
           <li class>
              <a href="{{ route('show-virtual-event') }}" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">     
      <div class="container-fluid">
        <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#mainRowCollapse" aria-expanded="false" aria-controls="mainRowCollapse">
          >
        </button>
        <!-- Toggle Collapse -->
        <div class="collapse" id="mainRowCollapse">
  ...
  <footer class="main-footer">
    <strong>© Department of Science &amp; Technology - Cordillera Administrative Region All Rights Reserved 2023</strong>
